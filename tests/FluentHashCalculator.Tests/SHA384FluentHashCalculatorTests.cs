...
namespace FluentHashCalculator.Tests
{
    public class SHA384FluentHashCalculatorTests
    {
        ...
        [Fact]
        public (byte[], byte[]) UsingAllPropertiesInCalculatorWhenComputeThenReturnSHA384()
        {
            var calculator = new AbstractHashCalculatorBuilder<EntityWithAllSupportedTypes>.SHA384();
            calculator.Using(e => e.BoolProperty)
        ...
        [Fact]
        public (byte[], byte[], byte[]) UsingComplexPropertyWithStringInCalculatorWhenComputeThenReturnEntityIdWithSameEncodingToParentCalculatorSHA384()
        {
        ...
        [Fact]
        public (byte[], byte[], byte[]) UsingComplexPropertyListWithStringInCalculatorWhenComputeThenReturnEntityIdWithSameEncodingToParentCalculatorSHA384()
        {
            // Tests without context inheritance
            var calculator = new AbstractHashCalculatorBuilder<EntityWithAllSupportedTypes>.SHA384();
