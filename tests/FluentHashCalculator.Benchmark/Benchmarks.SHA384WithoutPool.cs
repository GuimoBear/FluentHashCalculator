...
{
    [Description("SHA384")]
    public class SHA384FluentHashCalculatorWithoutPoolBenchmark : BenchmarkBase<byte[]>
    {
        [GlobalSetup]
        ...
        */
        ...
        {
            var calculator = new Calculators.AbstractHashCalculatorBuilder<Entity>.SHA384();
