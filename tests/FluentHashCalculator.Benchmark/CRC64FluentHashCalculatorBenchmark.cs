...
namespace FluentHashCalculator.Benchmark
{
    ...
    [MarkdownExporter]
    [MemoryDiagnoser]
    public class CRC64FluentHashCalculatorBenchmark
    {
        private Entity entity;
        private IAbstractHashCalculator<Entity, ulong> calculator;
        ...
        */
        ...
        private IAbstractHashCalculator<Entity, ulong> create()
        {
