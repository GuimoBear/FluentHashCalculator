...
namespace FluentHashCalculator.Internal.Utils
{
    /// <summary>
            ...
            unchecked
            {
                ...
                switch (obj)
                {
                    ...
                    default:
                        ...
                        throw new NotSupportedException($"Unhandled expression node type '{obj.NodeType}'.");
                }
            ...
            public bool Compare(Expression left, Expression right)
            {
                ...
                return left switch
                {
                    ...
                    _ => left.NodeType == ExpressionType.Extension
                        ? left.Equals(right)
                        : throw new InvalidOperationException($"Unhandled expression node type '{left.NodeType}'.")
                };
            }
